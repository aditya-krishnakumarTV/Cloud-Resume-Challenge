...
import { Phone, Mail, MapPin, Github, Linkedin, FileUser } from "lucide-react";
      ...
      <div className="bg-gray-500">
        <div className="max-w-7xl mx-auto p-10 scale-z-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 space-y-6 gap-8">
            ...
            <div className="container flex items-center space-x-4 p-4 m-1 rounded-lg border border-white bg-gray-200 transition hover:-translate-y-1 hover:shadow-lg shadow-white ease-in-out duration-400">
              <div className="w-12 h-12 rounded-lg flex items-center justify-center">
                <FileUser />
              </div>
              <div className="flex-1">
